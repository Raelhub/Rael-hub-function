...
-- Função que você pode chamar com um texto e um idioma de destino
local function TranslateText(text, targetLang)
    local translatedText = TranslateTo(text, targetLang)
...
return ({
    ...
    TranslateText = TranslateText -- Adicionei a função TranslateText no retorno
})