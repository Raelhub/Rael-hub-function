...
local configFolder = "RaelHub SR B1C4" -- Pasta onde os arquivos de tradução serão salvos
...
function TranslationModule:GetTabs()
    ...
    local AdditionalTranslations = {
      badendingtext = RaelHubTradutor.Tradutor("(Bad Ending)"),
      goodendingtext = RaelHubTradutor.Tradutor("(Good Ending)"),
      section2 = RaelHubTradutor.Tradutor("Remove statues that don't move"),
      button2 = RaelHubTradutor.Tradutor("Remove statue"),
      notifytrue = RaelHubTradutor.Tradutor("Statue removed"),
      notifyfalse = RaelHubTradutor.Tradutor("The statues have already been removed")
    ...
    screenGui:Destroy()
    return Main, AdditionalTranslations, Jogador, Mostrar, Creditos
end
