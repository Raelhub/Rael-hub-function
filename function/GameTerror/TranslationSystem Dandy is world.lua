...
local configFolder = "RaelHub Dandy is world" -- Pasta onde os arquivos de tradução serão salvos
...
function TranslationModule:GetTabs()
    ...
    local Main = {
        ...
        section2 = RaelHubTradutor.Tradutor("Teleportar para os geradores", currentLanguage),
        section3 = RaelHubTradutor.Tradutor("Auto coletar itens", currentLanguage),
        button1 = RaelHubTradutor.Tradutor("Zona segura", currentLanguage),
        button2 = RaelHubTradutor.Tradutor("Teleportar para elevador", currentLanguage),
        button3 = RaelHubTradutor.Tradutor("Teleportar para o gerador", currentLanguage),
    ...
    local Mostrar = {
        ...
        toggle1 = RaelHubTradutor.Tradutor("Esp geradores", currentLanguage),
        toggle2 = RaelHubTradutor.Tradutor("Esp itens", currentLanguage),
        toggle3 = RaelHubTradutor.Tradutor("Esp monstros", currentLanguage),
        toggle4 = RaelHubTradutor.Tradutor("Esp players", currentLanguage),
