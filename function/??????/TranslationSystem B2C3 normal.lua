...
function TranslationModule:GetTabs()
    ...
    if getgenv().RaelHubAutoTranslator then
      ...
      local Tab_Mapmaze = {
        ...
        section2 = RaelHubTradutor.Tradutor("Safe area", currentLanguage),
        section3 = RaelHubTradutor.Tradutor("Self make torch", currentLanguage),
        section4 = RaelHubTradutor.Tradutor("Light the torch", currentLanguage),
        section5 = RaelHubTradutor.Tradutor("Pass the gate", currentLanguage),
    ...
    elseif getgenv().RaelHubAutoTranslator == false then
      ...
      local Tab_Mapmaze = {
        ...
        section2 = "Safe area",
        section3 = "Self make torch",
        section4 = "Light the torch",
        section5 = "Pass the gate",
        button1 = "Esp GrinDemon [Normal]",
        button2 = "Esp GrinDemon [Nightmare]",
        button3 = "Safe zone",
