...
function TranslationModule:GetTabs()
    ...
    if getgenv().RaelHubAutoTranslator and currentLanguage == "pt" then
      ...
      local House = {
        ...
        button3 = "Pegar permissão",
        button4 = "Teleportar para a casa",
        button5 = "Teleportar para o cofre",
        button6 = "Tocar a música",
        button7 = "Salvar a playlist",
        button8 = "Carrgar a playlist",
        dropdowntext1 = "Casas",
      ...
      local Jogador = { 
        ...
        button2 = "Teleportar para jogador",
        button3 = "Matar jogador",
        button4 = "Puxar jogador",
      ...
      local House = {
        ...
        toggle5 = "Spawn lights",
        button1 = "Remove ban",
        button2 = "Update house list",
        button3 = "Get permission",
        button4 = "Teleport to the house",
        button5 = "Teleport to the vault",
        button6 = "Play the music",
        button7 = "Save the playlist",
        button8 = "Load the playlist",
      ...
      local Clothes = {
        ...
        button4 = "Copy nearest player's skin",
        button5 = "Copy random player's skin",
