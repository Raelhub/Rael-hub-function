...
function NotificationManager:createNotification(texto, duracao)
    ...
    -- Criar a imagem de fundo corretamente
    ...
    notificationText.Size = UDim2.new(1, 0, 0, 15)  -- Tamanho adaptável
    ...
    -- Atualiza a altura do notificationText com base na largura
