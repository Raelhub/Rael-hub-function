...
function RaelHubEspPDOORS.EspBookAtivado()
  ...
  for _, BookPasta in ipairs(BooksPastas:GetChildren()) do
    if BookPasta:IsA("Model") then
      ...
      if Pasta then
        for _, Bookshelves1 in ipairs(Pasta:GetChildren()) do
          if Bookshelves1.Name == "Bookshelves1" then
            for _, object in ipairs(Bookshelves1:GetChildren()) do
              local LiveHintBook = object:FindFirstChild("LiveHintBook")
              if LiveHintBook and not LiveHintBook:FindFirstChild("RaelHubDestaque") and not LiveHintBook:FindFirstChild("RaelHubIcon") then
                
                CreateEsp1(LiveHintBook, Color3.fromRGB(222, 3, 123), "112846382225194", "")
      ...
      if Pasta then
        for _, Bookshelves1 in ipairs(Pasta:GetChildren()) do
          if Bookshelves1.Name == "Bookshelves1" then
            for _, object in ipairs(Bookshelves1:GetChildren()) do
              local LiveHintBook = object:FindFirstChild("LiveHintBook")
              if LiveHintBook and LiveHintBook:FindFirstChild("RaelHubDestaque") and LiveHintBook:FindFirstChild("RaelHubIcon") then
                
                LiveHintBook:FindFirstChild("RaelHubDestaque"):Destroy()
            
                LiveHintBook:FindFirstChild("RaelHubIcon"):Destroy()
